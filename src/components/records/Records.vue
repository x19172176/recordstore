  ...
  <div class="max-w-md m-auto py-10">
    ...
    <form @submit.prevent="addRecord">
      ...
      <div class="mb-6">
        ...
        <p class="pt-4">Don't see an artist? <router-link to="/artists" class="link-gray-200">Create one</router-link></p>
      </div>

      <input type="submit" value="Add Record" class="font-sans font-bold px-4 rounded cursor-pointer no-underline bg-green-600 hover:bg-green-dark block w-full py-4 text-white items-center justify-center">
    </form>
    ...
    <ul class="list-reset mt-4">
      <li class="py-4" v-for="record in records" :key="record.id" :record="record">
        ...
        <button class="bg-transparent text-sm hover:bg-red-200 text-red-200 hover:text-white no-underline font-bold py-2 px-4 rounded border border-red-200"
